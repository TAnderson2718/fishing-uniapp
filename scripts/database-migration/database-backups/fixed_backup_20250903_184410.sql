...
DROP DATABASE IF EXISTS fishing_platform_shared;
--
-- TOC entry 4131 (class 1262 OID 27071)
-- Name: fishing_platform_shared; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE fishing_platform_shared WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = icu LOCALE = 'en_US.UTF-8' ICU_LOCALE = 'en-US';


\connect fishing_platform_shared
